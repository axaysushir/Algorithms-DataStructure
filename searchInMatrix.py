...
# and the first number of each row will always be greater than the last element of the last 
# row (mat[i][0] > mat[i - 1][-1]), search for a specific value in the matrix and return whether it exists.
